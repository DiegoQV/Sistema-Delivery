    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-b from-green-50 to-white px-6 pt-16 pb-10 flex flex-col items-center text-center">
        ...
        <p className="text-stone-500 text-sm leading-relaxed">
          Tu pedido <span className="font-bold text-stone-900">#{idCorto}</span> fue enviado<br />
      ...
      <div className="px-4 flex flex-col gap-4 -mt-2">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex gap-3">
          ...
          <p className="text-xs text-amber-700 leading-relaxed">
            Si elegiste <strong>Yape/Plin</strong>, no olvides adjuntar el screenshot del pago en el chat de WhatsApp.
          </p>
        </div>
