    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-b from-green-50 to-white px-6 pt-16 pb-10 flex flex-col items-center text-center">
        ...
        <p className="text-stone-500 text-sm leading-relaxed">
          Tu solicitud <span className="font-bold text-stone-900">#{idCorto}</span> fue enviada
          por WhatsApp para coordinar recojo y entrega.
        </p>
      </div>
      ...
      <div className="px-4 flex flex-col gap-4 -mt-2">
        ...
        <section className="bg-white rounded-3xl border border-stone-100 shadow-sm overflow-hidden">
          ...
          <div className="px-4 py-4 space-y-4">
            {[
              { num: "1", icon: "📲", texto: "Recibimos tu solicitud por WhatsApp",           color: "bg-blue-100 text-blue-600"    },
              { num: "2", icon: "✅", texto: "Confirmamos el punto y la hora de recojo",       color: "bg-green-100 text-green-600"  },
              { num: "3", icon: "🛵", texto: "El motorizado recoge y traslada tu pedido",      color: "bg-orange-100 text-orange-600"},
              { num: "4", icon: "📍", texto: "Recibes tu entrega en la dirección indicada",    color: "bg-amber-100 text-amber-600"  },
            ].map((paso) => (
        ...
        >
          <span>🛵</span>
          <span>Solicitar otro delivery</span>
        </button>

        <p className="text-center text-xs text-stone-400 pb-4">
          ¿Necesitas ayuda con tu entrega? Escríbenos directamente por WhatsApp.
        </p>
      </div>
    </div>
  );
