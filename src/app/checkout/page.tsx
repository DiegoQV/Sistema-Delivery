  ...
  if (totalItems === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-white">
        <div className="w-24 h-24 rounded-full bg-orange-50 flex items-center justify-center mb-5 text-5xl">🛵</div>
        <p className="text-stone-900 font-bold text-lg">Tu carrito está vacío</p>
        <p className="text-stone-400 text-sm mt-1">Elige un negocio y coordinamos la entrega</p>
        <button
          onClick={() => router.push("/")}
    ...
    <div className="flex flex-col min-h-screen bg-stone-50 pb-8">
      ...
      <header className="sticky top-0 z-40 bg-white shadow-sm px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="font-extrabold text-stone-900 text-base leading-tight">Confirmar delivery</h1>
      ...
      <div className="px-4 py-4 flex flex-col gap-4">
        ...
        <section className="bg-white rounded-3xl shadow-sm border border-stone-100 overflow-hidden">
          <div className="px-4 py-3 border-b border-stone-50 flex items-center gap-2">
            ...
            <h2 className="font-bold text-stone-900 text-sm">Productos para recoger</h2>
          </div>
        ...
        >
          {enviando ? (
            ...
            <>
              ...
              <span>Solicitar delivery por WhatsApp</span>
            </>
          )}
        </button>
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-stone-500 text-center leading-relaxed px-2">
          Realiza el pago y <strong className="text-stone-700">adjunta el comprobante</strong> cuando solicites tu delivery por WhatsApp.
        </p>
